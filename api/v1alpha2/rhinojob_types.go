...
const (
	RhinoJobPending    JobStatus = "Pending"
	RhinoJobRunning    JobStatus = "Running"
	RhinoJobFailed     JobStatus = "Failed"
	RhinoJobCompleted  JobStatus = "Completed"
	RhinoJobImageError JobStatus = "ImageError"
)
