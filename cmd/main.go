...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "b62d3386.openrhino.org",
	...
	if err = (&controllers.RhinoJobReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "RhinoJob")
		os.Exit(1)
	}
	if err = (&openrhinoorgv1alpha2.RhinoJob{}).SetupWebhookWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create webhook", "webhook", "RhinoJob")
		os.Exit(1)
	}
